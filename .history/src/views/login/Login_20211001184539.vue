...
export default {
    ...
    methods:{
        loginAccount(){
            loginRequest(this.account,this.password,this.role);
        },
        switchToShang(){
            this.role = "0";
            this.$ref.business.className = "shangjia pressed";
            this.$ref.admin.className = "guanliyuan";
        },
        switchToGuan(){
            this.role = "1";
            this.$ref.admin.className = "guanliyuan pressed";
            this.$ref.business.className = "shangjia";
        }
    }
}
</script>
