  ...
  <div class="Login">
    ...
    <div class="main-container">
      ...
      <div class="Login-contianer">
        ...
        <div class="option">
          <div ref="business" class="shangjia pressed" @click="switchToShang">
            商家
          </div>
        ...
        <div ref="wrongAccount" class="warning username">
          <img src="../../assets/img/login/warning.png" alt="" />
          <div class="content">不存在该用户</div>
        </div>
        <div ref="wrongPassword" class="warning password">
          <img src="../../assets/img/login/warning.png" alt="" />
